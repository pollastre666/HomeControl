...
import { componentData } from './persianasData'; // Ajusta la ruta
...
const PersianasComponents = ({
  ...
  description = 'Explora los componentes esenciales que combinan tecnología y diseño para tus persianas.',
}) => {
  ...
  // Función para asignar íconos basados en el id
  function getIconById(id) {
    const iconMap = {
      lamasAluminio: <Scissors size={16} />,
      cajonPVC: <Settings size={16} />,
      ejeAcero: <Plug size={16} />,
      motorSmart: <Smartphone size={16} />,
      guiasLaterales: <AlignJustify size={16} />,
      controlRemoto: <Weight size={16} />,
    };

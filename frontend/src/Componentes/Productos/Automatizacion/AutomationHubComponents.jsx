...
import { componentData } from './automationHubData';
...
// Mapeo de íconos para componentes del Automation Hub
const getIconById = (id) => {
  const iconMap = {
    'central-unit': <Camera size={16} />,
    'connectivity-module': <Bell size={16} />,
    sensors: <Radio size={16} />,
    'app-interface': <Lock size={16} />,
    'voice-control': <Smartphone size={16} />,
    'power-supply': <Mail size={16} />,
  };
  return iconMap[id] || <ChevronRight size={16} />;
};

const AutomationHubComponents = React.memo(({ title = 'Componentes del Automation Hub', description = 'Centraliza la automatización de tu hogar con estos elementos clave.' }) => {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        console.error('Error loading automation hub data:', err);
...
AutomationHubComponents.displayName = 'AutomationHubComponents';

...
import { componentData } from './smartHomeAutomationData';
...
// Mapeo de íconos para componentes de automatización
const getIconById = (id) => {
  const iconMap = {
    'motorized-shutters': <Camera size={16} />, // Ícono representativo
    'smart-lighting': <Bell size={16} />,
    'climate-control': <Radio size={16} />,
    'smart-plugs': <Lock size={16} />,
    'automation-controller': <Smartphone size={16} />,
    'scene-scheduler': <Mail size={16} />,
  };
  return iconMap[id] || <ChevronRight size={16} />;
};

const SmartHomeAutomationComponents = React.memo(({ title = 'Componentes de Smart Home Automatismos', description = 'Automatiza tu hogar con los mejores componentes inteligentes.' }) => {
...
SmartHomeAutomationComponents.displayName = 'SmartHomeAutomationComponents';

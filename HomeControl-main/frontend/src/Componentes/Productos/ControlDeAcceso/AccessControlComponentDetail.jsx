...
import { componentData, getCompatibilityMessage } from './accessControlData';
  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      try {
        ...
        if (!data) {
          throw new Error(`Componente ${componentId} no encontrado en control de acceso`);
        }
        setComponent(data);
      } catch (err) {
      ...
      >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <Link
            ...
            aria-label="Volver a la página de control de acceso"
          >
          ...
          <RelatedSecurityProducts currentId={componentId} category="access-control" />

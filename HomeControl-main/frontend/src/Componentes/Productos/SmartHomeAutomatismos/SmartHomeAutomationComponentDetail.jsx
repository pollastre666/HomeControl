...
import { componentData, getCompatibilityMessage } from './smartHomeAutomationData';
  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      try {
        ...
        if (!data) {
          throw new Error(`Componente ${componentId} no encontrado en automatismos`);
        }
        setComponent(data);
      } catch (err) {
      ...
      >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <Link
            ...
            aria-label="Volver a la página de automatismos"
          >
          ...
          <RelatedSecurityProducts currentId={componentId} category="automation" />

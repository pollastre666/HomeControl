...
import CameraFeatures from '../Detalles/Features';
import CameraSpecifications from '../Detalles/Specifications';
...
import RelatedSecurityProducts from '../Detalles/RelatedProducts';
import Breadcrumbs from '../ComponetesDeCartas/Breadcrumbs';
import CheckoutModal from '../Detalles/CheckoutModal';
import { componentData, getCompatibilityMessage } from './automationHubData';
  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      try {
        ...
        if (!data) {
          throw new Error(`Componente ${componentId} no encontrado en Automation Hub`);
        }
        setComponent(data);
      } catch (err) {
      ...
      >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <Link
            ...
            aria-label="Volver a la página de Automation Hub"
          >
            <ArrowLeft className="mr-2" size={20} />
            Volver a Automation Hub
          </Link>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 mb-16">
            <div className="flex-1 space-y-6">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-6">
                ...
                <div className="flex items-center space-x-4 mt-2 sm:mt-0">
                  <p className="text-gray-600 dark:text-gray-300 text-lg">
                    Stock: {component.stock === Infinity ? 'Ilimitado' : `${component.stock} unidades`}
                  </p>
                  {component.stock !== Infinity && component.stock <= 5 && component.stock > 0 && (
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                {component.stock !== Infinity && component.stock > 0 ? (
                  <motion.button
          ...
          <RelatedSecurityProducts currentId={componentId} category="automation-hub" />

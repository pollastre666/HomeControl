...
import { componentData, getCompatibilityMessage } from './advancedSecurityData';
  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      try {
        ...
        if (!data) {
          throw new Error(`Componente ${componentId} no encontrado en seguridad avanzada`);
        }
        setComponent(data);
      } catch (err) {
      ...
      >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <Link
            ...
            aria-label="Volver a la página de seguridad avanzada"
          >
          ...
          <RelatedSecurityProducts currentId={componentId} category="security" />
